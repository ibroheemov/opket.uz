...
const BalanceCard: React.FC<{ balance: number }> = ({ balance }) => (
    <AppCard className="w-full">
        <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-white/90">Bonus</h2>
        </div>
        <p className="flex items-baseline">
            <span className="text-4xl font-bold text-white">{formatUZS(balance)}</span>
            <span className="ml-2 text-2xl font-medium text-gray-400">UZS</span>
        </p>
    </AppCard>
);
...
const WalletIcon: React.FC<{ className?: string }> = () => (

    <svg width="30px" height="30px" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet">
